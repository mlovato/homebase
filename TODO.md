# Homebase — Feature Ideas

## Planned

- [ ] **Quick-launch search bar** — keyboard-shortcut-activated (`⌘K`) spotlight-style modal that searches links by name and opens them without leaving the dashboard
