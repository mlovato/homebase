  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      <div className="w-full max-w-sm bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
        <h1 className="text-2xl font-bold text-indigo-600 dark:text-indigo-400 mb-1">Dashy</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Admin login</p>
