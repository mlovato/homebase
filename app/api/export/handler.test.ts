...
describe('export handler', () => {
  ...
  it('includes categories with their links, without DB ids', () => {
    ...
    createLink(db, userId, { category_id: cat.id, name: 'Plex', url: 'http://plex', icon_type: 'builtin', icon_value: 'plex', sort_order: 0 })
  ...
  it('includes uncategorized links without DB ids', () => {
    createLink(db, userId, { category_id: null, name: 'Misc', url: 'http://misc', icon_type: 'url', icon_value: 'http://icon', sort_order: 1 })
