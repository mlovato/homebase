...
describe('LinksTab', () => {
  ...
  it('renders uncategorized section when uncategorized links exist', () => {
    const uncategorized: Link[] = [
      { id: 9, category_id: null, name: 'Orphan', url: 'http://orphan', icon_type: 'builtin', icon_value: null, sort_order: 0 },
    ]
  ...
  it('calls handleDeleteCategory with confirmation when Delete is clicked', () => {
    ...
    render(<LinksTab {...baseProps} categories={[mediaCategory]} handleDeleteCategory={handleDeleteCategory} />)
