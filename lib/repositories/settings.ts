...
export function getSetting(db: Database.Database, userId: number, key: string): string | undefined {
...
export function getHealthCheckInterval(db: Database.Database, userId: number): HealthCheckInterval {
...
export function getSearchShortcut(db: Database.Database, userId: number): SearchShortcut {
